"""
Hacking The Fender project for Learn Python 3 course at Codecademy.
...
with open("hackingTheFender/passwords.csv") as password_file:
    ...
    for password_row in password_csv:
        ...
        #7. Remove the print statement. We want to add each username to the list of compromized_users. Use the list's .append() method to add the username to compromised_users instead of printing them.
        compromised_users.append(password_row['Username'])

# 8. Exit out of your with block for the "passwords.csv". We have all the data we need from that file. Start a new with block, opening a file called compromised_users.txt. Open this file in write-mode, saving the file object as compromised_user_file.
with open("hackingTheFender/compromised_users.txt", 'w') as compromised_user_file:
    
    # 9. Inside the new context-managed block opened by the with statement start a new for loop. Iterate over each of your compromised users.
...
with open('hackingTheFender/boss_message.json', 'w') as boss_message:
...
with open('hackingTheFender/new_passwords.csv', 'w') as new_passwords_obj:

    # 17. Enemy of the people, Slash Null, is who we want The Fender to think was behind this attack. He has a signature, whenever he hacks someone he adds this signature to one of the files he touches. Here is the signature: ... Save that as a multiline string to the variable slash_null_sig.
    slash_null_sig = """
 _  _     ___   __  ____             
/ )( \   / __) /  \(_  _)            
) \/ (  ( (_ \(  O ) )(              
...
# 19. What an incredible success! We'll take care of moving the new passwords file over the old one in case you want to practice hacking The Fender in the future. Thank you for your service, programmer.